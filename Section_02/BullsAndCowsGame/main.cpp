...
FBullCowGame BCGame;//instatiate a new game, which I re-use across plays
...
void PrintIntro() 
{
	...
	std::cout << "Welcome to Bools and Couts (aka Bulls and Cows), a fun word game.\n";
	std::cout << std::endl;
	std::cout << "          }   {         ___ " << std::endl;
	std::cout << "          (o o)        (o o) " << std::endl;
	std::cout << "   /-------\\ /          \\ /-------\\ " << std::endl;
	std::cout << "  / | BOOL |O            O| COUT  | \\ " << std::endl;
	std::cout << " *  |-,--- |              |------|  * " << std::endl;
	std::cout << "    ^      ^              ^      ^ " << std::endl;
